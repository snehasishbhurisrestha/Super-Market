...
<head>
    ...
    <title>Add Catagory | Market Admin</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="{{url('/ins_cata')}}" method="post">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="cata" class="form-control" placeholder="Enter catagory" id="cata">
                        </div>
